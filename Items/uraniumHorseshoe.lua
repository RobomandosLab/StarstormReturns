...
local sprite = Sprite.new("UraniumHorseshoe", path.combine(PATH, "Sprites/Items/uraniumHorseshoe.png"), 1, 14, 17)
local sprite_footstep = Sprite.new("UraniumHorseshoeFootstep", path.combine(PATH, "Sprites/Items/Effects/horseshoeFootstep.png"), 7, 3, 0)

-- create and setup the footstep particle
local parHorseshoe = Particle.new("parHorshoe")
...
local horseshoe = Item.new("uraniumHorseshoe")
horseshoe:set_sprite(sprite)
horseshoe:set_tier(ItemTier.COMMON)
horseshoe.loot_tags = Item.LootTag.CATEGORY_UTILITY
