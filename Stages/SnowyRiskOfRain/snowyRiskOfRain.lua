...
Sprite.new("Spacer_M_CL_Snowy", 				path.combine(PATH, "Sprites/Stages/SnowyRiskOfRain/snowySpacer_M_CL.png"), 2, 0, 0)
Sprite.new("Spacer_M2_CL_Snowy", 				path.combine(PATH, "Sprites/Stages/SnowyRiskOfRain/snowySpacer_M2_CL.png"), 2, 0, 0)
